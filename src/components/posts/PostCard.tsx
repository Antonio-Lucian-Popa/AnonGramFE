        ...
        <div className="p-5">
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              {post.tag && (
                <span className="inline-flex items-center gap-1 text-xs bg-indigo-900/50 text-indigo-300 py-1 px-2 rounded-full">
                  <Tag size={12} />
                  {post.tag}
                </span>
              )}
            ...
            <div className="flex items-center space-x-2">
              <button 
                ...
                className={`flex items-center space-x-1 rounded-md px-2 py-1 ${
                  userVote === 1 ? 'text-green-400 bg-green-900/30' : 'text-gray-400 hover:text-gray-200'
                }`}
              >
                <ThumbsUp size={16} />
              </button>
              ...
              <button 
                ...
                disabled={loading}
                className={`flex items-center space-x-1 rounded-md px-2 py-1 ${
                  userVote === -1 ? 'text-red-400 bg-red-900/30' : 'text-gray-400 hover:text-gray-200'
                }`}
              >
                <ThumbsDown size={16} />
              </button>
